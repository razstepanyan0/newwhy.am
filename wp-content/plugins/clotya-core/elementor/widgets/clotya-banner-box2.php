...
class Clotya_Banner_Box2_Widget extends Widget_Base {

    public function get_name() {
        return 'clotya-banner-box2';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control( 'title',
            [
                ...
                'default' => 'Best Sweatshirts and tracksuits for everyone!',
        ...
        $this->add_control( 'desc',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.',
	...
	protected function render() {
		...
		echo '<div class="banner dark content-start content-middle large">';
		echo '<div class="banner-content">';
		echo '<div class="banner-inner">';
		echo '<h4 class="entry-subtitle">'.esc_html($settings['subtitle']).'</h4>';
		echo '<h2 class="entry-title size-42">'.esc_html($settings['title']).'</h2>';
		echo '<div class="entry-description">';
		echo '<p>'.esc_html($settings['desc']).'</p>';
		echo '</div><!-- entry-description -->';
		if($settings['btn_title']){
			echo '<a href="'.esc_url($settings['btn_link']['url']).'" class="btn" '.esc_attr($target.$nofollow).'>'.esc_html($settings['btn_title']).' <i class="klbth-icon-right-arrow"></i></a>';
		}
