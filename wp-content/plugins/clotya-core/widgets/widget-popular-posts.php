...
class widget_popular_posts extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array('description' => esc_html__('Display the popular posts','clotya-core') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'popular_posts' );
		 parent::__construct( 'popular_posts', esc_html__('Clotya Popular Posts','clotya-core'), $widget_ops, $control_ops );
	}
				...
				<ul class="post-list-widget">
					...
					<?php $popularpost = new WP_Query( array( 
								'posts_per_page' => $number,
								 'meta_key' => 'clotya_post_views_count',
                    ...
                    <li class="post">
							<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
								...
								$imgresize = clotya_resize( $image_src, 100, 100, true, true, true );   
								?>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Number of items to show:','clotya-core'); ?></label>
