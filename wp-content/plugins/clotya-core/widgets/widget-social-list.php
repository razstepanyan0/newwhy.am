...
class widget_social_list extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array('description' => esc_html__('Only Detail Page: Social List.','clotya-core') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'social_list' );
		 parent::__construct( 'social_list', esc_html__('Clotya Social list','clotya-core'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		<?php $sociallist = get_theme_mod( 'clotya_social_list_widget' ); ?>
	...
	function form($instance) {
		...
		<p>
		  <?php esc_html_e('You can customize the social list from Dashboard > Appearance > Customize > Clotya Widgets > Social List','clotya-core'); ?>
