                    ...
                    if($my_temps->have_posts()) {
                        foreach ( $my_temps->posts as $temp ) {
                            ...
                            <li data-keyword="<?php echo esc_attr($temp_title); ?>">
                                ...
                                <div>
                                    <button type="button" class="palleon-btn primary palleon-select-template" data-json="<?php echo esc_url($temp_url); ?>" data-version="free"><span class="material-icons">check</span><?php echo esc_html__('Select', 'palleon'); ?></button>
