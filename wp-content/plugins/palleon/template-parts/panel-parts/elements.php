            ...
            <ul id="palleon-elements-wrap" class="palleon-accordion">
                ...
                if (!empty($post_list) && is_array($post_list)) {
                    foreach ( $post_list as $post ) {
                        ...
                        echo '<li data-keyword="' . $post->post_name . '"><a>' . $post->post_title . '<span class="data-count">' . count($c_elements) . '</span><span class="material-icons arrow">keyboard_arrow_down</span></a><div><div id="palleon-custom-elements-grid-' . $post->post_name . '" class="palleon-grid palleon-elements-grid four-column paginated" data-perpage="' . $perpage . '">';
