								...
								<?php
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											...
											esc_html__( 'Remove this item', 'clotya' ),
											esc_attr( $product_id ),
						...
						<div class="actions-wrapper">
							<?php if ( wc_coupons_enabled() ) { ?>
								<div class="coupon">
									...
									<button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'clotya' ); ?>"><?php esc_attr_e( 'Apply coupon', 'clotya' ); ?></button>
